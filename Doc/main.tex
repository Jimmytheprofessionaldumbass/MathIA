...
the same idea will be repeated for each axis and afterwards applied to the calculated velocity values to find displacement. This is the integration of accelerometer data to displacement when the phone is swung left and right 5 times. We get the following graph:
